...
namespace AppWeb.Controllers
{
    public class AccesoController : Controller
    {
            ...
            try
            {
                using (ColegioEntities db = new ColegioEntities())
                {
                    ...
                    if (usuario != null)
                    {
                        ...
                        usuario.Contraseña_Usuario = Hash("123456");
                        db.SaveChanges();
        ...
        private void EnviarCorreo(string destinatario, string asunto, string cuerpo)
        {
            ...
            smtp.Host = "smtp.terminalbogota.com.co"; // Especificar el servidor SMTP que utilizará
            ...
            smtp.Credentials = new NetworkCredential("sistemas.tbc@terminalbogota.com.co", "*CWsVoDjx3"); // Especificar las credenciales de autenticación del remitente
           

            // Configurar el mensaje de correo electrónico
            MailMessage mensaje = new MailMessage();
            mensaje.From = new MailAddress("sistemas.tbc@terminalbogota.com.co"); // Especificar la dirección de correo electrónico del remitente
